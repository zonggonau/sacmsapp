...
| A3  | Prompt injection lewat prompt pengguna                         | AI mengabaikan aturan, membocorkan system prompt | Sejak ADR-011 prompt dikirim apa adanya ke v0: karakter tak terlihat dibuang, pola mencurigakan dicatat, tidak ada rahasia di prompt, pratinjau di iframe sandbox |
